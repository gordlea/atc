...
type FakeContainerProvider struct {
	...
	FindOrCreateContainerStub        func(logger lager.Logger, cancel <-chan os.Signal, creatingContainer *dbng.CreatingContainer, createdContainer *dbng.CreatedContainer, delegate worker.ImageFetchingDelegate, id worker.Identifier, metadata worker.Metadata, spec worker.ContainerSpec, resourceTypes atc.ResourceTypes, outputPaths map[string]string) (worker.Container, error)
...
func (fake *FakeContainerProvider) FindOrCreateContainer(logger lager.Logger, cancel <-chan os.Signal, creatingContainer *dbng.CreatingContainer, createdContainer *dbng.CreatedContainer, delegate worker.ImageFetchingDelegate, id worker.Identifier, metadata worker.Metadata, spec worker.ContainerSpec, resourceTypes atc.ResourceTypes, outputPaths map[string]string) (worker.Container, error) {
	...
	fake.findOrCreateContainerArgsForCall = append(fake.findOrCreateContainerArgsForCall, struct {
		...
		resourceTypes     atc.ResourceTypes
		outputPaths       map[string]string
	}{logger, cancel, creatingContainer, createdContainer, delegate, id, metadata, spec, resourceTypes, outputPaths})
	fake.recordInvocation("FindOrCreateContainer", []interface{}{logger, cancel, creatingContainer, createdContainer, delegate, id, metadata, spec, resourceTypes, outputPaths})
	fake.findOrCreateContainerMutex.Unlock()
	if fake.FindOrCreateContainerStub != nil {
		return fake.FindOrCreateContainerStub(logger, cancel, creatingContainer, createdContainer, delegate, id, metadata, spec, resourceTypes, outputPaths)
	} else {
...
func (fake *FakeContainerProvider) FindOrCreateContainerArgsForCall(i int) (lager.Logger, <-chan os.Signal, *dbng.CreatingContainer, *dbng.CreatedContainer, worker.ImageFetchingDelegate, worker.Identifier, worker.Metadata, worker.ContainerSpec, atc.ResourceTypes, map[string]string) {
	fake.findOrCreateContainerMutex.RLock()
	defer fake.findOrCreateContainerMutex.RUnlock()
	return fake.findOrCreateContainerArgsForCall[i].logger, fake.findOrCreateContainerArgsForCall[i].cancel, fake.findOrCreateContainerArgsForCall[i].creatingContainer, fake.findOrCreateContainerArgsForCall[i].createdContainer, fake.findOrCreateContainerArgsForCall[i].delegate, fake.findOrCreateContainerArgsForCall[i].id, fake.findOrCreateContainerArgsForCall[i].metadata, fake.findOrCreateContainerArgsForCall[i].spec, fake.findOrCreateContainerArgsForCall[i].resourceTypes, fake.findOrCreateContainerArgsForCall[i].outputPaths
}
